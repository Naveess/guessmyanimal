(function () {
  ...
  /* -- Sound ---------------------------------------------------------
     ...
     by default has to be discovered to be heard. The toggle is its own
     fixed icon button (see .sound-toggle in index.html/style.css), not
     a menu item, since muting is a one-tap decision made mid-sound
